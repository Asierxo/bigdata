mkdir WorkspacePigAnalisisOpinionsExercici
cd WorkspacePigAnalisisOpinionsExercici

wget https://gitlab.com/jmmadronal/bigdata_aplicat/-/raw/main/pig/critiquescinematografiques.csv

hdfs dfs -mkdir pig_analisis_opinions_exercici
hdfs dfs -put *.csv /user/cloudera/pig_analisis_opinions
hdfs dfs -ls pig_analisis_opinions_exercici
