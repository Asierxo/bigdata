...
STORE pelis_opinions INTO '/user/cloudera/WorkspacePigAnalisisOpinions/resultat_analisis_opinions_pelicules' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'YES_MULTILINE');
